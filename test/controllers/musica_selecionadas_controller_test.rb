...
class MusicaSelecionadasControllerTest < ActionDispatch::IntegrationTest
  fixtures :musicas, :eventos, :musica_selecionadas
  ...
  test 'should create musica_selecionada' do
    assert_difference('MusicaSelecionada.count') do
      post musica_selecionadas_url, params: { musica_selecionada: {
        evento_id: @musica_selecionada.evento_id,
        momento: @musica_selecionada.momento,
        musica_id: @musica_selecionada.musica_id
      } }
    end
